...
const Footer = () => (
  <footer className="supportFooter">
    <div className="container">
      ...
      <p className="supportFooter__text supportFooter__text--left">Why is it always so difficult to find
      ...
      <p className="supportFooter__text supportFooter__text--right">Our mission is to give every dental
